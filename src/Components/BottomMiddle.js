...
function BottomMiddle() {
    ...
    const [women,setWomen]=useState([
     {rk:1, team:"https://cloudinary.fifa.com/api/v1/picture/flags-sq-2/SWE?tx=c_fill,g_auto,q_auto,w_70,h_46", country:"USA", tpoints:"2087.48"},
     {rk:2, team:"https://cloudinary.fifa.com/api/v1/picture/flags-sq-2/GER?tx=c_fill,g_auto,q_auto,w_70,h_46", country:"Sweden", tpoints:"2066.30"},
     ...
     {rk:4, team:"https://cloudinary.fifa.com/api/v1/picture/flags-sq-2/ENG?tx=c_fill,g_auto,q_auto,w_70,h_46", country:"France", tpoints:"2051.61"},
     {rk:5, team:"https://cloudinary.fifa.com/api/v1/picture/flags-sq-2/FRA?tx=c_fill,g_auto,q_auto,w_70,h_46", country:"England", tpoints:"2023.09"},
 ]);
...
<div style={{width:"400px",height:"100%",marginLeft:"300px",marginBottom:"-220px"}}>
...
<div style={{width:"400px",height:"100%",marginLeft:"750px",marginTop:"-513px"}}>
